...
func (o *operationsMock) listBuckets(svc svc) ([]s3.Bucket, error) {
	bucket := s3.Bucket{Name: &bucketNameMock, CreationDate: &creationDateMock}
	return []s3.Bucket{bucket}, nil
}

func (o *operationsMock) listObjects(svc svc, bucketName string, prefix string) ([]s3.Object, error) {
	object := s3.Object{Size: &sizeMock, LastModified: &lastModifiedMock, StorageClass: storageMock}
	return []s3.Object{object}, nil
}

func (o *operationsMock) getRegion(svc svc, bucketName string) (string, error) {
	return regionMock, nil
}

type operationsErrorMock struct{}

func (o *operationsErrorMock) listBuckets(svc svc) ([]s3.Bucket, error) {
	return nil, errors.New("list buckets error message")
}

func (o *operationsErrorMock) listObjects(svc svc, bucketName string, prefix string) ([]s3.Object, error) {
	return nil, errors.New("list objects error message")
}

func (o *operationsErrorMock) getRegion(svc svc, bucketName string) (string, error) {
